echo off
rem
rem File: make_clock.bat
rem
rem Purpose:
rem
rem    Build program that shows date / time on the screen in a loop.
rem
...
echo Building application "clock" ...
rem
rem build clock app.
rem
...
rem
..\bin2hex -f clock -o clock_prg.txt -w 1024 -x 1024 -z
...
rem
rem bin2hex -f clock -o clock_prg.txt -w 1024 -x 1024 -s
