...
rem build setdt app.
rem
cl65 -t none --cpu 6502 --config mkhbcoslib.cfg -l -m setdt.map setdt.c mkhbcos.lib
rem
...
rem
..\bin2hex -f setdt -o setdt_prg.txt -w 1024 -x 1024 -z
...
rem
rem bin2hex -f setdt -o setdt_prg.txt -w 1024 -x 1024 -s
