echo off
rem
rem File: make_setdt.bat
rem
rem Purpose:
rem
rem    Build program that allows to set date / time.
rem
...
echo Building application "setdt" ...
rem
rem build setdt app.
rem
cl65 -t none --cpu 6502 -I ..\system --config mkhbcoslib.cfg -l -m setdt.map setdt.c mkhbcos.lib
rem

echo Generating terminal program loading script "setdt_prg.txt" ...
rem
...
rem
..\bin2hex -f setdt -o setdt_prg.txt -w 2816 -x 2816 -z
...
rem
rem bin2hex -f setdt -o setdt_prg.txt -w 2816 -x 2816 -s
