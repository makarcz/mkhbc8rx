...
rem build d2hb app.
rem
cl65 -t none --cpu 6502 --config mkhbcoslib.cfg -l -o d2hb -m d2hb.map d2hexbin.c mkhbcos.lib
rem
...
rem
..\bin2hex -f d2hb -o d2hb_prg.txt -w 1024 -x 1024 -z
...
rem
rem bin2hex -f d2hb -o d2hb_prg.txt -w 1024 -x 1024 -s
