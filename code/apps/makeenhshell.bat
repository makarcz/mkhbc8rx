...
rem
cl65 -t none --cpu 6502 --config mkhbcoslib.cfg -l -m enhshell.map enhshell.c mkhbcos.lib
rem
...
rem
..\bin2hex -f enhshell -o enhshell_prg.txt -w 1024 -x 1024 -z
...
rem
rem bin2hex -f enhshell -o enhshell_prg.txt -w 1024 -x 1024 -s
