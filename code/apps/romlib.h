...
extern uint16_t _BRAM_START__, _BRAM_SIZE__;

#define SIZE_BRAM       ((unsigned)&_BRAM_SIZE__)
#define START_BRAM      ((unsigned)&_BRAM_START__)
#define END_BRAM        (((unsigned)&_BRAM_START__) + SIZE_BRAM)
