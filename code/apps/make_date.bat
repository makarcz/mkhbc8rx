...
rem build date app.
rem
cl65 -t none --cpu 6502 -I ..\system --config mkhbcoslib.cfg -l -m date.map date.c mkhbcos.lib
rem
...
rem
..\bin2hex -f date -o date_prg.txt -w 2816 -x 2816 -z
...
rem
rem bin2hex -f date -o date_prg.txt -w 2816 -x 2816 -s
